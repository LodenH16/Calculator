...
const { applyMiddleware, createStore, combineReducers, bindActionCreators } =
  Redux;
  ...
  switch (action.type) {
      ...
      if (state.string === "0") {
        ...
        if (action.payload !== "0") {
          return {
            saved: state.saved,
            string:
              state.string.substring(0, state.string.length - 1) +
              action.payload,
          };
        } else {
    ...
    case "function":
      if (action.payload == "-" && state.string == 0) {
        ...
        typeof state.saved[state.saved.length - 1] === "string" &&
        (state.string == "0" || state.string == "-")
      ) {
        return {
          string: "0",
          saved: [
            ...state.saved.filter(
              (value, index) => index !== state.saved.length - 1
            ),
            action.payload,
          ],
        };
        ...
        return {
          saved: [...state.saved, parseFloat(state.string), action.payload],
          string: "0",
        };
      }
    case "equals":
      return {
        saved: [],
        string: equate([...state.saved, parseFloat(state.string)]),
      };
...
function NumButton(props) {
  return /*#__PURE__*/ React.createElement(
    "div",
    {
      class: "numBTN noselect",
      onClick: () =>
        store.dispatch({ type: "number", payload: props.value.toString() }),
      id: props.id,
    },
    props.value
  );
...
function Funky(props) {
  return /*#__PURE__*/ React.createElement(
    "div",
    {
      class: "function noselect",
      id: props.id,
      onClick: () =>
        store.dispatch({ type: "function", payload: props.symbol }),
    },
    props.symbol
  );
}
function Equality(props) {
  return /*#__PURE__*/ React.createElement(
    "div",
    {
      class: "function noselect",
      id: "equals",
      onClick: () => store.dispatch({ type: "equals" }),
    },
    props.symbol
  );
}
...
function Decimal(props) {
  return /*#__PURE__*/ React.createElement(
    "div",
    {
      id: "decimal",
      class: "noselect",
      onClick: () => store.dispatch({ type: "decimal" }),
    },
    "."
  );
}
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      "div",
      {
        id: "zero",
        class: "noselect",
        onClick: () => store.dispatch({ type: "number", payload: "0" }),
      },
      "0"
    );
  }
...
ReactDOM.render(
  /*#__PURE__*/ React.createElement(Calcutator, null),
